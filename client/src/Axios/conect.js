...
const api = axios.create({
  baseURL: import.meta.env.VITE_API_URL || (window.location.hostname === 'localhost' ? 'sgc-production-railway.up.railway.app/api' : 'sgc-production-railway.up.railway.app')
});
